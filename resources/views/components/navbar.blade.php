        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <!-- Profile dropdown -->
                    @auth
                        <x-profil--dropdown></x-profil->
                        @else
                            <x-nav-link href="{{ route('login.index') }}" :active="request()->routeIs('login.index')"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Login</x-nav-link>
                        @endauth
                </div>
            </div>
