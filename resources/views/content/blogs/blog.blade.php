<x-layout>
    ...
    <a href="{{ route('blog.blog-create.index') }}"
        class="btn bg-blue-500 text-white px-3 py-2 rounded-md hover:bg-blue-400">Add Blog</a>

    <div class="mt-5">
        @foreach ($blogs as $blog)
        <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mb-3">
